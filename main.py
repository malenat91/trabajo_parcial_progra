from validaciones import (contar_tipos_caracteres, generar_reporte, buscar_caracter,
contra_invertida, validar_contra_vacia, validar_seguridad, verificar_palindromo, mostrar_menu)
